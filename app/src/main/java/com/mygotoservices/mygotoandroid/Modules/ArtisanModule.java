...
public class ArtisanModule {
    int listing_id,category_id,provider_id,instock,sold;
    String name,description,currency,listing_type,status;
    double unit_price,avg_ratings,bookings;
    ...
    public ArtisanModule(int listing_id, int category_id, int provider_id, int instock, int sold, String name, String description, String currency, String listing_type, String status, double unit_price, double avg_ratings, double bookings, ListingModule listing, ProviderModule provider, UserModule user, List<ImageModule> images, CategoryModule category, String image) {
    ...
    public void setBookings(double bookings) {
        this.bookings = bookings;
    }
