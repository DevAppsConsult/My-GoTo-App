...
public class MyBooking {
    ...
    String delivery_information,delivery_method,delivered_at,payment_means,order_code,transaction_id,phone,network,token,uuid,start_time,status,payment_status,description,created_at,location,landmark,transaction_reference;
    ArtisanModule listing;
    List<ImageModule> images;
    CategoryModule category;
    RatingModule rated;

    public MyBooking(int order_id, int user_id, int id, int listing_id, int provider_id, double amount, double delivery_charge, double processing_fee, double number_hours, double total_charge, double ratings, double lon, double lat, String delivery_information, String delivery_method, String delivered_at, String payment_means, String order_code, String transaction_id, String phone, String network, String token, String uuid, String start_time, String status, String payment_status, String description, String created_at, String location, String landmark, String transaction_reference, ArtisanModule listing, List<ImageModule> images, CategoryModule category, RatingModule rated) {
    ...
    public MyBooking(int order_id, int user_id, int id, int listing_id, int provider_id, double amount, double delivery_charge, double processing_fee, double number_hours, double total_charge, double ratings, double lon, double lat, String delivery_information, String delivery_method, String delivered_at, String payment_means, String order_code, String transaction_id, String phone, String network, String token, String uuid, String start_time, String status, String payment_status, String description, String created_at, String location, String landmark, String transaction_reference, ArtisanModule listing, List<ImageModule> images, CategoryModule category) {
        this.order_id = order_id;
        this.user_id = user_id;
        this.id = id;
        this.listing_id = listing_id;
    ...
    public MyBooking(int order_id, int user_id, double amount, double delivery_charge, double processing_fee, String delivery_information, String delivery_method, String status, String payment_status, String delivered_at, String transaction_reference, String payment_means, String order_code, String transaction_id, String phone, String network, String token, ArtisanModule listing) {
        this.order_id = order_id;
        this.user_id = user_id;
        this.amount = amount;
        this.delivery_charge = delivery_charge;
    ...
    public MyBooking(int order_id, int user_id, int id, int listing_id, int provider_id, double amount, double delivery_charge, double processing_fee, double number_hours, double total_charge, double ratings, double lon, double lat, String delivery_information, String delivery_method, String delivered_at, String payment_means, String order_code, String transaction_id, String phone, String network, String token, String uuid, String start_time, String status, String payment_status, String description, String created_at, String location, String landmark, String transaction_reference, ArtisanModule listing) {
        this.order_id = order_id;
        this.user_id = user_id;
        this.id = id;
        this.listing_id = listing_id;
    ...
    public ArtisanModule getListing() {
        return listing;
    }

    public void setListing(ArtisanModule listing) {
        this.listing = listing;
    }
