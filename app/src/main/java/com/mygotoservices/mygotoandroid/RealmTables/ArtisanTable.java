...
public class ArtisanTable extends RealmObject{
    @PrimaryKey
    int provider_id;
    int user_id;
    String uuid,location,landmark,lon,lat,status,visible_name,image,description,service_type;

    public ArtisanTable(int provider_id, int user_id, String uuid, String location, String landmark, String lon, String lat, String status, String visible_name, String image, String description, String service_type) {
